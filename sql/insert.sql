...
-- noticed font awesome had these shapes so might as well
INSERT INTO sticker (account_id, name, description, date_created)
VALUES (1, 'Pentagonal Sticker', 'A sticker that has five sides.', current_date);
INSERT INTO polygonal_sticker
VALUES (4, 'pentagon');

INSERT INTO sticker (account_id, name, description, date_created)
VALUES (1, 'Hexagonal Sticker', 'A sticker that is hexagonal.', current_date);
INSERT INTO polygonal_sticker
VALUES (5, 'hexagon');

INSERT INTO sticker (account_id, name, description, date_created)
VALUES (1, 'Septagonal Sticker', 'A sticker that is septagonal.', current_date);
INSERT INTO polygonal_sticker
VALUES (6, 'septagon');

INSERT INTO sticker (account_id, name, description, date_created)
VALUES (1, 'Octagonal Sticker', 'A sticker that is octagonal.', current_date);
INSERT INTO polygonal_sticker
VALUES (7, 'octagon');

INSERT INTO sticker (account_id, name, description, date_created)
VALUES (1, 'Star Sticker', 'A star.', current_date);
INSERT INTO polygonal_sticker
VALUES (8, 'star');
...
INSERT INTO image_sticker (sticker_id, image_data)
VALUES (11, 'pretend this is an image byte data');
